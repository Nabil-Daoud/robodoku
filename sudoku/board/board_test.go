...
func TestLoad(t *testing.T) {
	...
	expectedBoard = Build([]uint8{32, 32, 32, 50, 54, 32, 55, 32, 49, 10, 54, 56, 32, 32, 55, 32, 32, 57, 32, 10, 49, 57, 32, 32, 32, 52, 53, 32, 32, 10, 56, 50, 32, 49, 32, 32, 32, 52, 32, 10, 32, 32, 52, 54, 32, 50, 57, 32, 32, 10, 32, 53, 32, 32, 32, 51, 32, 50, 56, 10, 32, 32, 57, 51, 32, 32, 32, 55, 52, 10, 32, 52, 32, 32, 53, 32, 32, 51, 54, 10, 55, 32, 51, 32, 49, 56, 32, 32, 32, 10})
	gotBoard = Build([]uint8{32, 32, 32, 50, 54, 32, 55, 32, 49, 10, 54, 56, 32, 32, 55, 32, 32, 57, 32, 10, 49, 57, 32, 32, 32, 52, 53, 32, 32, 10, 56, 50, 32, 49, 32, 32, 32, 52, 32, 10, 32, 32, 52, 54, 32, 50, 57, 32, 32, 10, 32, 53, 32, 32, 32, 51, 32, 50, 56, 10, 32, 32, 57, 51, 32, 32, 32, 55, 52, 10, 32, 52, 32, 32, 53, 32, 32, 51, 54, 10, 55, 32, 51, 32, 49, 56, 32, 32, 32, 10})
	assert.Equal(t, expectedBoard, gotBoard, "9x9 board did not load correctly")

	expectedBoard2 = Board{[][]uint8{{3, 2, 4, 1}, {4, 1, 3, 2}, {1, 4, 2, 3}, {2, 0, 0, 4}}}
	gotBoard2 = Build([]uint8{51, 50, 52, 49, 10, 52, 49, 51, 50, 10, 49, 52, 50, 51, 10, 50, 32, 32, 52, 10})
	assert.Equal(t, expectedBoard2, gotBoard2, "4x4 board did not load correctly.")

	expectedBoard3 = Board{[][]uint8{{1, 2}, {2, 0}}}
	gotBoard3 = Build([]uint8{49, 50, 10, 50, 32, 10})
	assert.Equal(t, expectedBoard3, gotBoard3, "2x2 board did not load correctly.")
